...
![Orientation Field](https://github.com/ViktorBusk/fingerprint-matching/blob/main/recourses/orientation_field_beta_1_0_0.png?raw=true) <!-- .element height="50%" width="50%" -->
